...
public interface CustomerRepo
  ...
  @Modifying
  @Query(
      "UPDATE Customer u SET u.mobileVerified=:verified ,u.mobileVerifiedTime=CURRENT_TIMESTAMP  WHERE id=:userId")
  ...
  @Modifying
  @Query(
      "UPDATE Customer u SET u.firstName = :name , u.deliveryAddress = :address WHERE u.id = :userId")
