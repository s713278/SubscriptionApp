...
public class CacheConfig {
  ...
  public CaffeineCacheManager dbCache() {
    ...
    cacheManager.setCaffeine(
        Caffeine.newBuilder()
            .expireAfterWrite(
                globalConfig.getCacheConfig().getDbDataTTL(),
                TimeUnit.MINUTES) // Set TTL to 10 minutes
  ...
  public CaffeineCacheManager cacheManager() {
    ...
    cacheManager.setCaffeine(
        Caffeine.newBuilder()
            .expireAfterWrite(
                globalConfig.getCacheConfig().getOtpTTL(),
                TimeUnit.MINUTES) // OTP and attempts expire after 5 minutes
            .maximumSize(globalConfig.getCacheConfig().getOtpMax())); // Maximum cache size
    return cacheManager;
  }
}
