...
public class SecurityConfig {
  ...
  @Autowired private AppFilter appFilter;
  ...
  public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    http
        ...
        .authorizeHttpRequests(
            auth -> {
              auth.requestMatchers(HttpMethod.GET, AppConstants.PUBLIC_GET_URLS)
                  .permitAll()
                  .requestMatchers(HttpMethod.POST, AppConstants.PUBLIC_POST_URLS)
                  .permitAll()

                  // User-level access
                  .requestMatchers(HttpMethod.PATCH, AppConstants.USER_PATCH_URLS)
                  .hasAnyAuthority("USER")
                  .requestMatchers(HttpMethod.PUT, AppConstants.USER_PUT_URLS)
                  .hasAnyAuthority("USER")
                  .requestMatchers(HttpMethod.GET, AppConstants.USER_GET_URLS)
                  .hasAnyAuthority("USER", "ADMIN")

                  // User and Vendor level access
                  .requestMatchers(HttpMethod.PATCH, AppConstants.VENDOR_USER_SUB_PATCH_URLS)
                  .hasAnyAuthority("USER", "VENDOR")
                  .requestMatchers(HttpMethod.POST, AppConstants.VENDOR_USER_SUB_POST_URLS)
                  .hasAnyAuthority("USER", "VENDOR")
                  .requestMatchers(HttpMethod.DELETE, AppConstants.VENDOR_USER_SUB_DELETE_URLS)
                  .hasAnyAuthority("USER", "VENDOR")
                  .requestMatchers(HttpMethod.GET, AppConstants.VENDOR_USER_SUB_GET_URLS)
                  .hasAnyAuthority("USER", "VENDOR")
        ...
        .logout(
            logout ->
                logout
                    .logoutUrl(AppConstants.SIGN_OUT_URL)
        ...
        .exceptionHandling(
            t ->
                t.authenticationEntryPoint(authenticationEntryPoint /*
