...
public class UserOrderService {
    ...
    public Resource exportOrderHistoryToCsv(Long userId, LocalDate startDate, LocalDate endDate) {
        ...
        try (StringWriter writer = new StringWriter();
             CSVPrinter csvPrinter = new CSVPrinter(writer, CSVFormat.DEFAULT.withHeader("Id", "Delivery Date", "Vendor Name", "Item Name", "Size", "Quantity", "Amount", "Discount", "Total Amount", "Total Discount"))) {
    ...
    public void sendOrderHistoryByEmail(Long userId, LocalDate startDate, LocalDate endDate, String email) {
        ...
        try {
            ...
            InputStreamSource csvAttachment = new ByteArrayResource(csvResource.getInputStream().readAllBytes());
