...
public class DefaultVendorService  extends  AbstractVendorService{
    ...
    public DefaultVendorService(NotificationContext notificationContext, UserService userService, RepositoryManager repoManager, ModelMapper modelMapper) {
    ...
    protected void postCreateVendorProfile(Long vendorId,String mobileNumber){
        ...
        getNotificationContext().notifyUser(NotificationType.SMS, NotificationTemplate.PROFILE_UPDATES, mobileNumber);
    }
    ...
    public List<VendorProfileRequest> fetchAllVendors() {
        ...
        return stores.stream().map(store -> modelMapper.map(store, VendorProfileRequest.class))
    ...
    public List<VendorProfileRequest> fetchVendorsByServiceArea(String serviceArea) {
        ...
        return vendorsList.stream().map(vendor->modelMapper.map(vendor, VendorProfileRequest.class)).toList();
    }
    ...
    public PaginationResponse<VendorBasicDTO> fetchActiveVendorsByZipCode(String zipCode, Long categoryId, Integer pageNumber, Integer pageSize) {
    ...
    public PaginationResponse<VendorBasicDTO> fetchActiveVendorsByZipCodeAndProduct(String zipCode, Long productId, Integer pageNumber, Integer pageSize) {
        Pageable pageDetails = PageRequest.of(pageNumber, pageSize);
