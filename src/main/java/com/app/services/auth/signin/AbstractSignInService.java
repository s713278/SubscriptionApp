  ...
  protected AuthDetailsDTO getSignInResponse(AuthUserDetails userDetails) {
    ...
    if (!globalConfig.getCustomerConfig().isOtpVerificationEnabled()
      ...
      serviceManager
          ...
          .sendOTPMessage(NotificationType.SMS, userDetails.getFullMobileNumber());
      return responseBuilder.message("OTP sent to your registered mobile number.").build();
    }
  }
}
