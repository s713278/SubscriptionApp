...
public class Sku extends AbstractAuditingEntity<Long> implements Serializable {
  ...
  private Integer
      serviceValidDays; // This is primarily for SERVICE type skus and Determine how many days the
  // service is active.

  // @CollectionTable(name = "tb_sku_sub_plan",joinColumns = @JoinColumn(name = "sku_id"))
  // @Enumerated(EnumType.STRING)
  // @ElementCollection(fetch = FetchType.EAGER)
  @Transient private List<SubFrequency> eligibleSubPlan; // For custom date range
