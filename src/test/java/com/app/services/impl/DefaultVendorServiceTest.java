...
class DefaultVendorServiceTest {
    ...
    @Autowired
     DefaultVendorService vendorService;

    @Autowired
    MobileSignUpService mobileSignUpService;
    ...
    void testCreateVendorByAdmin() {
        ...
        profileRequest.setServiceAreas(Map.of("areas", List.of("502108","502103","Mirdoddi","Siddipet")));
        profileRequest.setContactNumber("9912149047");
        profileRequest.setOwnerName("Swamy Kunta");
        profileRequest.setBusinessAddress(Map.of("address1","33 Acres Land",
                "city","Mirdoddi","zipCode","502108"));
        UserAuthentication userAuthentication=new UserAuthentication(adminUserResponse.userId(),Set.of(new SimpleGrantedAuthority(UserRoleEnum.ADMIN.name())));
        ...
        Assertions.assertAll(()->{
            ...
            Assertions.assertEquals(adminUserResponse.userId(),Long.parseLong(vendorEntity.get().getCreatedBy()));
        });
    }
    ...
    void testCreateVendorWithVendorRole() {
      ...
      //  Vendor profileRequest=new Vendor();
        ...
        profileRequest.setBusinessAddress(Map.of("address1","33 Acres Land",
                "city","Mirdoddi","zipCode","502108"));
        UserAuthentication userAuthentication=new UserAuthentication(response.userId(),Set.of(new SimpleGrantedAuthority(UserRoleEnum.VENDOR.name())));
    ...
    void testFetchVendorByMobile(){
        ...
        UserAuthentication userAuthentication=new UserAuthentication(1000L,Set.of(new SimpleGrantedAuthority(UserRoleEnum.ADMIN.name())));
